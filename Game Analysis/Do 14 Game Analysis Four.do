log using "C:/Users/Owner/OneDrive/Documents/Georgetown University/Thesis Writer/Research/QB Worth/Game Analysis/Do 14 Game Analysis Four.smcl", replace
clear all
scalar t1 = c(current_time)
use "C:/Users/Owner/OneDrive/Documents/Georgetown University/Thesis Writer/Research/QB Worth/Game Analysis/Data 25 Final Dataset Four.dta"
...
foreach x in Rate ANYA TANYA FPA {
	...
	* Instrumental Variables
	foreach z in "" "NoQ4" {
		quietly ivregress 2sls Win (DiffGame`x' = DiffSeason`x'`z') DiffNonQBFantPt DiffHome DiffRestDays DifflogIM DiffSGini DiffSNSRatio DiffFE*, vce(cluster GameID)
		* Generate Matrices for Coefs, Variances, and R2s
...
save "C:/Users/Owner/OneDrive/Documents/Georgetown University/Thesis Writer/Research/QB Worth/Season Analysis/Data 14 AME Four.dta", replace
log close
...
forvalues i = 1/`Reps' {
    ...
    foreach x in Rate ANYA TANYA FPA {
        capture {
            quietly logit Win DiffSeason`x' DiffNonQBFantPt DiffHome DiffRestDays DifflogIM DiffSGini DiffSNSRatio DiffFE*, vce(cluster GameID)
...
save "C:/Users/Owner/OneDrive/Documents/Georgetown University/Thesis Writer/Research/QB Worth/Season Analysis/Data 17 Game Bootstrap.dta", replace
timer off 1
timer list 1
